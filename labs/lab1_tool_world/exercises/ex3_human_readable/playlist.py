...
create_playlist_url = "https://api.spotify.com/v1/users/71fivnpli1kuhaz6zajg61k4r/playlists"
# %% Get the token
...
print("Playlist created with url %s" %
...
params = {"uris": uris, }
req = requests.post(url=add_item_playlist_url.format(
    playlist_id=playlist_info["id"]), json=params, headers=header)
assert req.status_code == 201, req.content
